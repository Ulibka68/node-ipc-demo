...
declare module 'node-ipc' {
  ...
  export interface Client {
    ...
    /**
     * если true - можно слать сообщения
     */
    enableEmit: boolean;
  ...
  // export default const RootIPC: NodeIPC.IPC & { IPC: new () => NodeIPC.IPC };

  export type RootIPC = IPC & { IPC: new () => IPC };
  ...
  // export = RootIPC;
  // export default IPC;
  // declare var ipc: IPC & { config: Config } & { server: Server };
}
